...
class PulseShell extends StatelessWidget {
  ...
  @override Widget build(BuildContext context) => Scaffold(body: SafeArea(child: child), bottomNavigationBar: PulseBottomNavigation(currentPath: currentPath));
}
...
class _DestinationTile extends StatelessWidget {
  ...
  final _PulseDestination destination; final bool selected; final VoidCallback onTap;
  @override Widget build(BuildContext context) {
...
class _PulseDestination { const _PulseDestination(this.path, this.label, this.icon); final String path; final String label; final IconData icon; }
