...
class PulseCompletionCelebration extends StatefulWidget {
  ...
  @override
  State<PulseCompletionCelebration> createState() => _PulseCompletionCelebrationState();
}

class _PulseCompletionCelebrationState extends State<PulseCompletionCelebration>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted && !PulseMotionPolicy.isReducedMotion(context)) _controller.forward();
    });
  }
