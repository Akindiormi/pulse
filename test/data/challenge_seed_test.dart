...
void main() {
  test('seed contains 50 unique active challenges across all categories and difficulties', () {
    expect(challengeSeedData.length, 50);
    expect(challengeSeedData.map((e) => e.id).toSet().length, 50);
